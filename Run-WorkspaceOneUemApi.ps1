...
Try
{
    ...
    If (-not (Test-Path -LiteralPath $moduleWorkspaceOneUemApiMain -PathType 'Leaf'))
    { 
        Throw "Module does not exist at the specified location [$moduleWorkspaceOneUemApiMain]."
    }
